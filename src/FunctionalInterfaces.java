...
public class FunctionalInterfaces {
    private static void m1() {
        Predicate<Integer> isPositive = x -> x > 0; //есть один метод
    ...
    private static void m2() {
        ...
        BinaryOperator<StringBuilder> op = StringBuilder::append;   /*(sb1, sb2) -> sb1.append(sb2);*/
...
//                .map(string -> stringToNumberNotOptional(string)) //FunctionalInterfaces::stringToNumberNotOptional
//                .filter(num -> num != null) //Objects::nonNull
...
//                .collect(Collectors.toList());
    ...
    private static void streamsExamples() {
        ...
        long numberOfElementsStartsWitB=strings.stream()
